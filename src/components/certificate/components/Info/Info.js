    ...
    return (
        <div className="info__container">
            <div className="info__header-container">
                ...
                <div className="info__header-item active">
                    Проекты(практика)
                </div>
                ...
                return (
                    <div className="info" key={key}>
                        ...
                        <div className="info__block">
                            ...
                            >
                                {item.description.map((descr, key) => (
                                    <div
                                        className="info__block-description-descr"
                                        key={key}
                                    >
                                        {descr}
                                    </div>
                        ...
                        <div className="info__block">
                            ...
                            {item.attachments.map((file, index) => (
                                <div
                                    className="info__attachments"
                                    onClick={() =>
                                        window.open(file.file, '_blank').focus()
                                    }
                                >
                                    <div>
                                        <img src={Pdf} alt="pdf" />
                                    </div>
                                    <div className="info__attachments-name">
                                        {file.name}
                                    </div>
                                </div>
                            ))}
